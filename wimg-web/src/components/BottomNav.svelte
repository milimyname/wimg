<script lang="ts">
  ...
  const tabs = [
    ...
    { href: "/review", label: "Rückblick", icon: "review" },
...
<nav
  class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl z-20 rounded-t-[2rem] shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.05)]"
